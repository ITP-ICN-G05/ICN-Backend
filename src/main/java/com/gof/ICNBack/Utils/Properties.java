...
public class Properties{
    public static final String EMAIL_NAME = "app.mail.name";
    public static final String EMAIL_WEBSITE = "app.mail.website";
    ...
    public static final String DAO_DEBUG = "app.dao.debug";
